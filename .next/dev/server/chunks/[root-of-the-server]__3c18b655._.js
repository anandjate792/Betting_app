...
async function GET(request) {
    try {
        ...
        if (current) {
            const now = new Date();
            const slot = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                startTime: {
                    $lte: now
                },
                endTime: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3c18b655._.js.map