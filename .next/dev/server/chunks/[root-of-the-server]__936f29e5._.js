...
"[project]/app/api/prediction-slots/auto-create/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        key: "autoCreateSlots"
    });
...
async function POST(request) {
    try {
        ...
        if (url.searchParams.get("toggle") === "true") {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                key: "autoCreateSlots"
            }, {
                value: enabled
            }, {
        ...
        while(attempts < 100){
            try {
                const existingWithNumber = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    slotNumber
                });
                ...
                newSlot = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                    slotNumber,
                    startTime: nextSlotStart,
                    endTime: nextSlotEnd,
                    status: "open",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__936f29e5._.js.map