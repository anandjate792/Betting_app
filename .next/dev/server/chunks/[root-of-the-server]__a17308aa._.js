...
"[project]/app/api/withdrawals/[withdrawalId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, context) {
    try {
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["connectDB"])();
        const withdrawal = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$Withdrawal$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(resolvedParams.withdrawalId);
        if (!withdrawal) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (action === "reject") {
            ...
            await withdrawal.save();
            const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(withdrawal.userId);
            if (user) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a17308aa._.js.map