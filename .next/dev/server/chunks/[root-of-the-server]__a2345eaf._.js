...
"[project]/OneDrive/Desktop/Betting_app/lib/models/PredictionSlot.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/OneDrive/Desktop/Betting_app/lib/models/Setting.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/OneDrive/Desktop/Betting_app/app/api/prediction-slots/auto-create/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OneDrive/Desktop/Betting_app/lib/models/PredictionSlot.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$Setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/OneDrive/Desktop/Betting_app/lib/models/Setting.ts [app-route] (ecmascript)");
;
;
;
;
async function GET() {
    ...
    const setting = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$Setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        key: "autoCreateSlots"
    });
...
async function POST(request) {
    try {
        ...
        if (url.searchParams.get("toggle") === "true") {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$Setting$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                key: "autoCreateSlots"
            }, {
                value: enabled
            }, {
        ...
        const existingSlot = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
        ...
        let slotNumber = 1;
        const lastSlot = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne().sort({
            slotNumber: -1
        });
        if (lastSlot) {
        ...
        while(attempts < 100){
            try {
                const existingWithNumber = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
                    slotNumber
                });
                ...
                newSlot = await __TURBOPACK__imported__module__$5b$project$5d2f$OneDrive$2f$Desktop$2f$Betting_app$2f$lib$2f$models$2f$PredictionSlot$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
                    slotNumber,
                    startTime: nextSlotStart,
                    endTime: nextSlotEnd,
                    status: "open",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a2345eaf._.js.map