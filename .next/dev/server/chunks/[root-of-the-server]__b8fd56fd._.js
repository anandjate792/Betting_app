...
const isAdmin = (token)=>{
    ...
    const decoded = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyToken"])(token);
...
async function GET(request) {
    try {
        ...
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}, "-password").sort({
            createdAt: -1
        });
...
async function POST(request) {
    try {
        ...
        const newUser = new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$User$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
            name,
            email,
            password,
            role: "user"
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8fd56fd._.js.map