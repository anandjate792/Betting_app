    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BetPlacedVoice.useEffect": ()=>{
            ...
            if ("speechSynthesis" in window) {
                const message = totalAmount ? `Bet placed successfully for ₹${totalAmount}` : "Bet placed successfully";
        ...
        "WinLossVoice.useEffect": ()=>{
            ...
            if ("speechSynthesis" in window) {
                ...
                if (result === "win") {
                    ...
                    message = amount ? `You loss ₹${amount} on slot ${slotNumber || ""}` : `You loss on slot ${slotNumber || ""}`;
                }
                const msg = new SpeechSynthesisUtterance(message);
                msg.lang = "en-IN"; // sounds good for Indian accent
                msg.rate = 1;
...
_s(WinLossVoice, "1J9HHJDL8dmIzzaFlufXHzWooew=");
_c = WinLossVoice;
var _c;
