...
function useDebounce(callback, delay) {
    ...
    const debouncedCallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebounce.useCallback[debouncedCallback]": (...args)=>{
            if (timeoutRef.current) {
                clearTimeout(timeoutRef.current);
            }
            timeoutRef.current = setTimeout({
                "useDebounce.useCallback[debouncedCallback]": ()=>{
                    callback(...args);
                }
            }["useDebounce.useCallback[debouncedCallback]"], delay);
        }
    }["useDebounce.useCallback[debouncedCallback]"], [
        callback,
        delay
...
_s(useDebounce, "v/nO0QHUWEkIY9wcmjuG2qH1HiY=");
function useThrottle(callback, delay) {
    _s1();
    const lastCallRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    const throttledCallback = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useThrottle.useCallback[throttledCallback]": (...args)=>{
            const now = Date.now();
    ...
    }["useThrottle.useCallback[throttledCallback]"], [
        callback,
        delay
    ]);
    return throttledCallback;
}
_s1(useThrottle, "sH0h0AS4XovKHf9eFCv3L+AG3Mo=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/ui/loading-skeleton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.k.register(_c1, "IconSkeleton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const initializeAudio = ()=>{
    if (("TURBOPACK compile-time value", "object") !== 'undefined' && !window.audioContext) {
...
"[project]/components/bet-placed-voice.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
function BetPlacedVoice({ betPlaced, totalAmount }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BetPlacedVoice.useEffect": ()=>{
            if (!betPlaced || hasPlayed.current) return;
            // Play bet-placed.mp3 sound instead of speech synthesis
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('bet-placed');
...
_s(BetPlacedVoice, "1J9HHJDL8dmIzzaFlufXHzWooew=");
_c = BetPlacedVoice;
var _c;
__turbopack_context__.k.register(_c, "BetPlacedVoice");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/win-loss-voice.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function WinLossVoice({ result, amount, slotNumber }) {
    _s();
    const hasPlayed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WinLossVoice.useEffect": ()=>{
            setSpeechSupported("speechSynthesis" in window);
            // Listen for user interaction
            const handleUserInteraction = {
                "WinLossVoice.useEffect.handleUserInteraction": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WinLossVoice.useEffect": ()=>{
            ...
            const speakWithFallback = {
                "WinLossVoice.useEffect.speakWithFallback": ()=>{
                    try {
                        let message = "";
                        if (result === "win") {
                            message = amount ? `You win ₹${amount} on slot ${slotNumber || ""}` : `You win on slot ${slotNumber || ""}`;
                        } else if (result === "loss") {
                            message = amount ? `You lose ₹${amount} on slot ${slotNumber || ""}` : `You lose on slot ${slotNumber || ""}`;
                        }
                        ...
                        msg.onerror = ({
                            "WinLossVoice.useEffect.speakWithFallback": (event)=>{
                                console.error('Win/Loss speech synthesis error:', event.error);
                                // Try fallback with different settings
                                if (event.error === 'synthesis-failed') {
                                    setTimeout({
                                        "WinLossVoice.useEffect.speakWithFallback": ()=>speakFallback()
                                    }["WinLossVoice.useEffect.speakWithFallback"], 100);
                                } else {
                                    hasPlayed.current = true;
                                }
                            }
                        ...
                        }["WinLossVoice.useEffect.speakWithFallback"], 50);
                    } catch (error) {
            ...
            const speakFallback = {
                "WinLossVoice.useEffect.speakFallback": ()=>{
                    try {
                        ...
                        msg.onerror = ({
                            "WinLossVoice.useEffect.speakFallback": (event)=>{
...
_s(WinLossVoice, "WEdilbqFk4P5iT4h0ve+5pGsi9g=");
_c = WinLossVoice;
var _c;
__turbopack_context__.k.register(_c, "WinLossVoice");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$loading$2d$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/ui/loading-skeleton.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/sounds.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$bet$2d$placed$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/bet-placed-voice.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$win$2d$loss$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/win-loss-voice.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
const IconButton = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["memo"])(_s(({ id, name, image, onClick, disabled, localBetAmount, confirmedBetAmount, totalBetAmount, hasMyBet, timeRemaining })=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IconButton.useEffect": ()=>{
            const img = new window.Image();
            img.onload = ({
                "IconButton.useEffect": ()=>setImageLoaded(true)
            })["IconButton.useEffect"];
            img.onerror = ({
                "IconButton.useEffect": ()=>setImageError(true)
            })["IconButton.useEffect"];
            img.src = image;
        }
    }["IconButton.useEffect"], [
    ...
    const handleClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IconButton.useCallback[handleClick]": ()=>{
            if (!disabled) {
                setIsPressed(true);
                setTimeout({
                    "IconButton.useCallback[handleClick]": ()=>setIsPressed(false)
                }["IconButton.useCallback[handleClick]"], 100);
                onClick();
            }
        }
    }["IconButton.useCallback[handleClick]"], [
    ...
    const handleTouchStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "IconButton.useCallback[handleTouchStart]": (e)=>{
            e.preventDefault(); // Prevent default to avoid double-tap zoom
            if (!disabled) {
                setIsPressed(true);
                setTimeout({
                    "IconButton.useCallback[handleTouchStart]": ()=>setIsPressed(false)
                }["IconButton.useCallback[handleTouchStart]"], 100);
                onClick();
            }
        }
    }["IconButton.useCallback[handleTouchStart]"], [
        disabled,
        onClick
    ]);
...
function DashboardPage() {
    ...
    const [slotWaitTime, setSlotWaitTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [betPlaced, setBetPlaced] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [betPlacedAmount, setBetPlacedAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [hasUserPlacedBetsInSlot, setHasUserPlacedBetsInSlot] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [winLossResult, setWinLossResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [winLossAmount, setWinLossAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    const [winLossSlotNumber, setWinLossSlotNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])();
    // Refs for tracking
    ...
    const hasUserInteractedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
            ...
            const updateTimer = {
                "DashboardPage.useEffect.updateTimer": ()=>{
                    ...
                    if (hasUserInteractedRef.current && diff <= 45000 && diff > 0) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('clock');
                    }
                }
            }["DashboardPage.useEffect.updateTimer"];
            updateTimer();
            ...
            if (slotWaitTime !== null && slotWaitTime > 0) {
                const timer = setTimeout({
                    "DashboardPage.useEffect.timer": ()=>{
                        setSlotWaitTime({
                            "DashboardPage.useEffect.timer": (prev)=>prev !== null ? prev - 1 : null
                        }["DashboardPage.useEffect.timer"]);
                    }
    ...
    const loadCurrentSlot = async ()=>{
        try {
            ...
            if (isNewActiveSlot) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('belt');
        ...
        try {
            ...
            if (!hasShownResult) {
                ...
                if (hasUserInteractedRef.current) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])(isWin ? "win" : "lose");
                }
    ...
    const handleIconClickThrottled = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$debounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThrottle"])({
        "DashboardPage.useThrottle[handleIconClickThrottled]": (iconId)=>{
            // Initialize audio context on first user interaction
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeAudio"])();
            ...
            setTimeout({
                "DashboardPage.useThrottle[handleIconClickThrottled]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])('belt')
            }["DashboardPage.useThrottle[handleIconClickThrottled]"], 0);
            // Optimized state update with immediate feedback
            setPlacedBets({
                "DashboardPage.useThrottle[handleIconClickThrottled]": (prev)=>{
                    const existingBetIndex = prev.findIndex({
                        "DashboardPage.useThrottle[handleIconClickThrottled].existingBetIndex": (bet)=>bet.icon === iconId
                    }["DashboardPage.useThrottle[handleIconClickThrottled].existingBetIndex"]);
            ...
            }["DashboardPage.useThrottle[handleIconClickThrottled]"]);
        }
    }["DashboardPage.useThrottle[handleIconClickThrottled]"], 50); // Faster throttle for mobile (50ms instead of 100ms)
    // Wrapper function to maintain the same interface
    const handleIconClick = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DashboardPage.useCallback[handleIconClick]": (iconId)=>{
            handleIconClickThrottled(iconId);
        }
    }["DashboardPage.useCallback[handleIconClick]"], [
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$bet$2d$placed$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                betPlaced: betPlaced,
                totalAmount: betPlacedAmount
            }, void 0, false, {
                fileName: "[project]/app/dashboard/page.tsx",
                lineNumber: 1035,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$win$2d$loss$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                            ...
                                            children: currentSlot ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                children: [
                                                    timeRemaining !== "Slot Closed" && timeRemaining !== "0:00" && timeRemaining !== "" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AnimatedClock, {
                                                        size: 24
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/dashboard/page.tsx",
                                                        lineNumber: 1161,
                        ...
                        children: [
                                    ...
                                    children: showWin ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    winningIconData ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            slotLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AnimatedClock, {
                                            size: 32
                                        }, void 0, false, {
                                            fileName: "[project]/app/dashboard/page.tsx",
                                            lineNumber: 1288,
                                        ...
                                        slotWaitTime !== null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                className: "space-y-3",
                                children: slotLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: Array.from({
                                                length: 12
                                            }).map((_, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$loading$2d$skeleton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconSkeleton"], {}, index, false, {
                                                    fileName: "[project]/app/dashboard/page.tsx",
                                                    lineNumber: 1324,
                                                    columnNumber: 13
                                                }, this))
                                    ...
                                    children: [
                                        timeRemaining === "Slot Closed" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        !hasUserInteractedRef.current && timeRemaining !== "Slot Closed" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            onClick: ()=>{
                                                // Initialize audio context on first user interaction
                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeAudio"])();
                                                hasUserInteractedRef.current = true;
                                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$sounds$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["playSound"])("clock"); // now allowed
                                            },
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: ICONS.map(({ id, name, image })=>{
                                                        ...
                                                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IconButton, {
                                                            id: id,
                                                            name: name,
                                                            image: image,
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                    ...
                                                    disabled: loading || placedBets.length === 0 || !currentSlot || Date.now() >= new Date(currentSlot.endTime).getTime() || timeRemaining === "Slot Closed" || hasUserPlacedBetsInSlot,
                                                    ...
                                                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        ...
                                                        lineNumber: 1502,
                                                        columnNumber: 11
                                                    }, this) : timeRemaining === "Slot Closed" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "flex items-center justify-center gap-1.5",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AnimatedClock, {
                                                                size: 16
                                                        ...
                                                        lineNumber: 1507,
                                                        columnNumber: 11
                                                    }, this) : hasUserPlacedBetsInSlot ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: "flex items-center justify-center gap-1.5",
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trophy$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Trophy$3e$__["Trophy"], {
                                                                className: "w-4 h-4"
...
_s1(DashboardPage, "or+RGqivjI9vZQW0VbrL9BomyW8=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$debounce$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useThrottle"]
    ];
});
_c2 = DashboardPage;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "IconButton");
__turbopack_context__.k.register(_c1, "AnimatedClock");
...
//# sourceMappingURL=_65465702._.js.map