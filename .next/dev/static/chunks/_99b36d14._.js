...
"[project]/components/bet-place-voice.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function BetPlaceVoice({ betPlaced, betAmount }) {
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BetPlaceVoice.useEffect": ()=>{
            if (!betPlaced || hasPlayed.current) return;
            if ("speechSynthesis" in window) {
                const message = betAmount ? `Bet placed successfully for ₹${betAmount}` : "Bet placed successfully";
...
_s(BetPlaceVoice, "r1HOeMc4BmFa1FJ9EsRp+g1v1bA=");
_c = BetPlaceVoice;
var _c;
__turbopack_context__.k.register(_c, "BetPlaceVoice");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"use client";
;
function WinLossVoice({ result, payout, betAmount }) {
    _s();
    const hasPlayed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WinLossVoice.useEffect": ()=>{
            ...
            if ("speechSynthesis" in window) {
                ...
                if (result === "win") {
                    if (payout && betAmount) {
                        message = `You win! You won ₹${payout} on your bet of ₹${betAmount}`;
                    } else if (payout) {
                        message = `You win! You won ₹${payout}`;
                    } else {
                        message = "You win!";
                    }
                } else if (result === "loss") {
                    if (betAmount) {
                        message = `You loss! You lost ₹${betAmount}`;
                    } else {
                        message = "You loss!";
                    }
                }
...
_s(WinLossVoice, "r1HOeMc4BmFa1FJ9EsRp+g1v1bA=");
_c = WinLossVoice;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$bet$2d$place$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/bet-place-voice.tsx [app-client] (ecmascript)");
...
function DashboardPage() {
    ...
    const [betSuccessfullyPlaced, setBetSuccessfullyPlaced] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [currentBetAmount, setCurrentBetAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [gameResult, setGameResult] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [gamePayout, setGamePayout] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [gameBetAmount, setGameBetAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    // Refs for tracking
    ...
    const checkSlotResult = async (slotId)=>{
        try {
            ...
            if (!hasShownResult) {
                ...
                // Trigger voice notification for win/loss
                setGameResult(isWin ? "win" : "loss");
                setGamePayout(payout);
                setGameBetAmount(totalBet);
                setTimeout(()=>{
                    setGameResult(null);
                }, 100); // Reset for next result
    ...
    const handleSubmitBets = async ()=>{
        ...
        try {
            ...
            // Clear placed bets
            setPlacedBets([]);
            // Calculate total bet amount for voice notification
            const totalBetAmount = getTotalBetAmount();
            setCurrentBetAmount(totalBetAmount);
            // Trigger voice notification for successful bet placement
            setBetSuccessfullyPlaced(true);
            setTimeout(()=>setBetSuccessfullyPlaced(false), 100); // Reset for next bet
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$bet$2d$place$2d$voice$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                betPlaced: betSuccessfullyPlaced,
...
_s1(DashboardPage, "wPJpTpPdzKEiuAudpG2Zq9V82rs=", false, function() {
    return [
...
//# sourceMappingURL=_99b36d14._.js.map