...
_s(BetPlacedVoice, "r1HOeMc4BmFa1FJ9EsRp+g1v1bA=");
_c = BetPlacedVoice;
var _c;
...
function DashboardPage() {
    ...
    const handleSubmitBets = async ()=>{
        ...
        try {
            ...
            // Trigger voice notification with total amount
            const totalBetAmount = getTotalBetAmount();
            setBetPlaced(true);
            setTimeout(()=>setBetPlaced(false), 100);
        } catch (err) {
...
_s1(DashboardPage, "2IznBFtjMIuOxbJukmFWQIOqO8g=", false, function() {
    return [
...
//# sourceMappingURL=_bd757e5b._.js.map